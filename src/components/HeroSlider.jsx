...
export default function HeroSlider() {
  ...
  if (loading) {
    return (
      <div className="w-full h-[300px] sm:h-[440px] lg:h-[540px] bg-primary/5 animate-pulse" />
    );
  }
  ...
  return (
    <section className="relative w-full h-[320px] sm:h-[460px] lg:h-[560px] overflow-hidden">
      {slides.map((s, i) => (
        <div
          key={s.id}
